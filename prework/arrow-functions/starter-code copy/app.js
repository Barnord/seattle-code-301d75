...
// When joe.scope() is invoked, "this" is the object that is Joe, and all the properties and methods.
// 2. What is "this" when joe.scopeArrow() is invoked?
// When joe.scopeArrow() is invoked, "this" seems to refer to javascript as a whole, and lists all of it's functions and variables.
// 3. Explain why "this" is different when an arrow function is used.
// Arrow functions aren't good with constructors.
